    ...
    return (
        <div className='footer'>
            ...
            <div className="Credit flex">
                <hr className='Hr HrFooter w-56' /><h1 className='NameCredit text-slate-50'>© 2024 Mohd Umair. All rights reserved.</h1><hr className='Hr HrFooter  w-56' />
            </div>
