        ...
        <div name="about" className='AboutPage'>
            ...
            <div className="aboutSection flex justify-between">
                ...
                <div className="AboutText">
                    <p className='aboutme my-5 text-sm'>Hello there! I'm a game developer at Ingenuity Gaming, diving into the world of coding during my 4th year of college. From C++ to Unity and C#, I've got 1.7 years of hands-on experience. Beyond games, I love working on MERN STACK and Spring Boot projects. Off the screen, you'll find me enjoying a game of cricket or taking a refreshing swim. Let's connect and explore the exciting possibilities of tech together!</p>
                    <hr />
                    ...
                    <p className='Email contactDetail flex my-5 gap-6'>
                        ...
                        umair.lari1998@gmail.com
                    </p>
                    <a href="mailto: umair.lari1998@gmail.com"><div className="Resume text-center cursor-pointer text-medium">Hire Me</div></a>
                </div>
            </div>
        </div>
    )
